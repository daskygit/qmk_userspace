...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    //                  LB,             MB,             RB,             FB, BB
    //                  CPI
    [0] = LAYOUT(KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN2, CUS_BTN5, CUS_BTN4,
                 QK_BOOT)};
...
//     {
//         {.driver = &pmw3389_driver_spi_default,
//          .config = &pmw3389_config_spi_default,
//          .throttle = 1,
//          .motion = {.pin = B0, .active_low = true}},
// };

void pointing_device_init_kb(void) { pointing_device_set_cpi(1600); }
